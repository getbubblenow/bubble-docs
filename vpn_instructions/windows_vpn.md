...
## Install WireGuard
  ...
  * You will see several warning dialogs to confirm that you really want to install WireGuard. It is safe to install WireGuard; depending on the dialog, click "OK", "Run", "Yes", or "Install" to continue. Screenshots of the confirmation dialogs are shown below.
